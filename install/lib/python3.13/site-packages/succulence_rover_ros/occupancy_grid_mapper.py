...
class OccupancyGrid:
    ...
    def world_to_grid(self, x: float, y: float) -> Tuple[int, int]:
        ...
        col = int((x - self.origin_x) / self.resolution) # Find where i am, reletive to origin, over the resolution to the map to find the index of the cell we are talking about
